...
import uuid from 'uuid';    //auto id generator
...
const expenseOne = store.dispatch(addExpense({ description: 'rent', amount: 75000, createdAt: -1000 }));
const expenseTwo = store.dispatch(addExpense({ description: 'coffee', amount: 250, createdAt: 1000 }));
const expenseThree = store.dispatch(addExpense({ description: 'coffee', amount: 150, createdAt: 500 }));
